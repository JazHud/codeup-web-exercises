...
// if (color === "blue") {
//     return (color + " is the color of the sea");
// } else if (color === "red"){
//     return ("Stop signs are red " + color);
// } else if (color === "pink"){
//     return ("Pigs are " + color);
// } else {
...
//     } else if (color === "red"){
//         alert ("Strawberries are red " + color);
//     } else {
...
// alert("Your discounted price today is " + (price - calculateTotal(luckyNumber, price)));
//
...
function getNumber(){
    if (confirm("Do you want to enter a number?")){
        return parseFloat(prompt("Please enter a number."));
    }
}
...
function analyzeNumber(number){
    ...
    if (isNumber(number)) {
        alert(isOddOrEven(number));
        alert(numberPlus100(parseInt(number)));
...
//
// let wantsToEnderNumber = confirm("Do you want to enter a number?");
// if (wantsToEnderNumber){
//     let userNumber = parseFloat(prompt("Enter a number"));
//     if (isNumber(userNumber)){
//         alert(isOddOrEven(userNumber));
